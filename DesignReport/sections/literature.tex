...
integrated output \cite{lee2010}. So given a test sample as the input, this
input vector is put down each of the trees, each tree gives a classification and
the forest selects the classification that has most votes.
...
them or not. The time complexity of RF is $O(n \log n)$ \cite{RFcompex}
