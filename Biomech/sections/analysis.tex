...
and bending moments. In this case point $c$ coincides with point $a$. Next the bending moment
...
After this the reduced bending moment diagram is treated as a distributed force acting
on the entire length of the beams. To calculate the equivalent forces of these
distributed forces the reduced bending moment diagram is divided into triangular parts
...
of the initial hyperstatic system. Therefore, a bending moment $m_a$ is added in the
...
\begin{equation}
	M_{HS} = M(L_1) = R_A \cdot L_1 = \frac{-L_1 \cdot L_2}{L_1 + L_2} \cdot F
\end{equation}
...
\begin{equation}
	 M_{HS} = \frac{L_1 L_2}{L_1 + L_2} F = 8 500.54
\end{equation}

\begin{equation}
	 M_{hs} = \frac{L_2 M_A}{L_1 + L_2} = 6 552.98
\end{equation}
