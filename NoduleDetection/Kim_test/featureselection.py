...
#     arrayDmin = np.reshape(windowDzmin, (h*w*d))
#     arrayDslice = np.reshape(arrayDmin, (d, h*w))
#     
#     mean_arrayDslice = mean
#     
#     
#     mean_arrayDmin = mean()
#     
#     MzPlus = (1/(Q-1)) * mean(arrayDmin)
#     
...
#     arrayDplus = np.reshape(windowDzplus, (h*w*d))
#     
#     MzPlus = (1/z) * sum(arrayDplus)
#     
#        
# 
