...
The annotations contain a list of readings by different radiologists. For
...
area and nodules hidden in the lung wall -- are closed by dilation. Note that
this causes part the lung walls to be included. We could get rid of this by
performing an extra erosion operation, but we chose to keep it to make sure
nodules attached to the wall are not lost. This mask is then exported to
Python for further processing of the images.
